...
HD_PWD='F:/FPGA_PROJECT/Servo/Servo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log servo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source servo.tcl -notrace
